...
let _floatingMs = null; // { menu, btn, ms, reposition }

function positionFloatingMs(menu, btn) {
...
function openFloatingMs(ms, menu, btn) {
  ...
  const reposition = (e) => {
    if (e && e.target && e.target !== document && menu.contains(e.target)) return;
...
export function toggleFloatingMs(ms, menu, btn) {

...
export function parseBackendError(rawError) {
...
export function translateBackendDetail(detail) {
...
export function buildSaveErrorMessage(rawError) {
...
export function setSaveButtonState(btn, saving, rootEl) {
  if (btn) {
    if (saving) {
...
function _setFormLocked(rootEl, locked, saveBtn) {
